...
import type { FullConfig, FullProject, TestStatus, TestError, Metadata } from '@playwright/test/types/test';
export type { FullConfig, TestStatus, TestError } from '@playwright/test/types/test';
