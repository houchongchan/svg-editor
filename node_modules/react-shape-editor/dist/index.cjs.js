...
var useNewEventEmitter = function () {
    var emitterRef = React.useRef(new EventEmitter());
...
var EventEmitterContext = React__default['default'].createContext(undefined);
var EventEmitterProvider = EventEmitterContext.Provider;
var useEventEmitterContext = function () {
    var emitter = React.useContext(EventEmitterContext);
...
var CoordinateGetterRefContext = React__default['default'].createContext(undefined);
var DimensionsContext = React__default['default'].createContext(undefined);
var dimensionsProviderPropTypes = {
    value: PropTypes__default['default'].shape({
        vectorWidth: PropTypes__default['default'].number.isRequired,
        vectorHeight: PropTypes__default['default'].number.isRequired,
        vectorPaddingTop: PropTypes__default['default'].number.isRequired,
        vectorPaddingRight: PropTypes__default['default'].number.isRequired,
        vectorPaddingBottom: PropTypes__default['default'].number.isRequired,
        vectorPaddingLeft: PropTypes__default['default'].number.isRequired,
...
var DimensionsProvider = function (_a) {
    ...
    var _b = React.useState(propDims), dimensions = _b[0], setDimensions = _b[1];
    ...
    return (React__default['default'].createElement(DimensionsContext.Provider, { value: dimensions }, children));
};
...
var useRootContext = function () {
    var coordinateGetterRef = React.useContext(CoordinateGetterRefContext);
    if (coordinateGetterRef === undefined) {
        throw new Error('useRootContext must be used within a CoordinateGetterRefProvider');
    }
    var dimensions = React.useContext(DimensionsContext);
...
var useChildAddDeleteHandler = function (focusOnAdd, focusOnDelete) {
    var justAddedShapeActionRefsRef = React.useRef([]);
    var wrappedShapeActionRefsRef = React.useRef([]);
    var lastDeletedRectRef = React.useRef(null);
...
var propTypes = {
    children: PropTypes__default['default'].node.isRequired,
    focusOnAdd: PropTypes__default['default'].bool,
    focusOnDelete: PropTypes__default['default'].bool,
    padding: PropTypes__default['default'].oneOfType([
        PropTypes__default['default'].number,
        PropTypes__default['default'].shape({
            top: PropTypes__default['default'].oneOfType([
                PropTypes__default['default'].number.isRequired,
                PropTypes__default['default'].oneOf([undefined]),
            ]).isRequired,
            right: PropTypes__default['default'].oneOfType([
                PropTypes__default['default'].number.isRequired,
                PropTypes__default['default'].oneOf([undefined]),
            ]).isRequired,
            bottom: PropTypes__default['default'].oneOfType([
                PropTypes__default['default'].number.isRequired,
                PropTypes__default['default'].oneOf([undefined]),
            ]).isRequired,
            left: PropTypes__default['default'].oneOfType([
                PropTypes__default['default'].number.isRequired,
                PropTypes__default['default'].oneOf([undefined]),
            ]).isRequired,
        }),
...
var ShapeEditor = React__default['default'].forwardRef(function (_a, forwardedRef) {
    ...
    var svgElRef = React.useRef(null);
    React.useImperativeHandle(forwardedRef, function () { return svgElRef.current; });
    ...
    return (React__default['default'].createElement("svg", __assign({ className: "rse-plane-container", width: vectorWidth * scale + paddingLeft + paddingRight, height: vectorHeight * scale + paddingTop + paddingBottom, preserveAspectRatio: "xMinYMin", viewBox: [
            -vectorPaddingLeft,
            -vectorPaddingTop,
        ...
        React__default['default'].createElement(CoordinateGetterRefProvider, { value: getVectorCoordinatesFromMouseEventRef },
            React__default['default'].createElement(EventEmitterProvider, { value: eventEmitter },
                React__default['default'].createElement(DimensionsProvider, { value: {
...
var propTypes$1 = {
    ...
    nativeActive: PropTypes__default['default'].bool.isRequired,
    cursor: PropTypes__default['default'].oneOf([
        'ns-resize',
        'ew-resize',
        'nesw-resize',
        'nwse-resize',
    ]).isRequired,
    isBeingChanged: PropTypes__default['default'].bool.isRequired,
    isInSelectionGroup: PropTypes__default['default'].bool.isRequired,
    name: PropTypes__default['default'].oneOf([
        'w',
        'n',
        's',
        'e',
    ...
    recommendedSize: PropTypes__default['default'].number.isRequired,
    scale: PropTypes__default['default'].number.isRequired,
...
var DefaultResizeHandleComponent = function (_a) {
    ...
    return (React__default['default'].createElement("rect", { fill: active ? 'rgba(229,240,244,1)' : 'rgba(229,240,244,0.3)', height: recommendedSize, stroke: active ? 'rgba(53,33,140,1)' : 'rgba(53,33,140,0.3)', strokeWidth: 1 / scale, style: { cursor: cursor, opacity: isInSelectionGroup ? 0 : 1 }, width: recommendedSize, x: x - recommendedSize / 2, y: y - recommendedSize / 2, 
...
var getHandles = function (ResizeHandleComponent, sides, scale, active, nativeActive, isInSelectionGroup, coordinateGetterRef, requestMouseHandler, setDragState, isBeingChanged) {
    ...
    var handles = handlesInfo.map(function (_a) {
        ...
        return (React__default['default'].createElement(ResizeHandleComponent, { key: handleName, active: active, nativeActive: nativeActive, cursor: cursor, isBeingChanged: isBeingChanged, isInSelectionGroup: isInSelectionGroup, name: handleName, onMouseDown: function (event) {
...
var useShapeActions = function (forwardedRef, props, forceFocusCb, getSelectionChildUpdatedRect, setDragState) {
    ...
    React.useImperativeHandle(forwardedRef, function () { return shapeActions; }, [
        props,
        forceFocusCb,
        setDragState,
    ]);
...
function wrapShape(WrappedComponent) {
    var propTypes = {
        ...
        constrainMove: PropTypes__default['default'].func,
        constrainResize: PropTypes__default['default'].func,
        disabled: PropTypes__default['default'].bool,
        height: PropTypes__default['default'].number.isRequired,
        isInSelectionGroup: PropTypes__default['default'].bool,
        isInternalComponent: PropTypes__default['default'].bool,
        keyboardTransformMultiplier: PropTypes__default['default'].number,
        onBlur: PropTypes__default['default'].func,
        onChange: PropTypes__default['default'].func,
        onDelete: PropTypes__default['default'].func,
        onFocus: PropTypes__default['default'].func,
        onKeyDown: PropTypes__default['default'].func,
        onIntermediateChange: PropTypes__default['default'].func,
        ResizeHandleComponent: PropTypes__default['default'].func,
        shapeId: PropTypes__default['default'].string.isRequired,
        width: PropTypes__default['default'].number.isRequired,
        wrapperProps: PropTypes__default['default'].shape({}),
        x: PropTypes__default['default'].number.isRequired,
        y: PropTypes__default['default'].number.isRequired,
    };
    var WrappedShape = React__default['default'].forwardRef(function (_a, forwardedRef) {
        var 
        ...
        var _p = React.useState(false), nativeActive = _p[0], setNativeActive = _p[1];
        ...
        var _s = React.useState(defaultDragState), _t = _s[0], isMouseDown = _t.isMouseDown, dragStartCoordinates = _t.dragStartCoordinates, dragCurrentCoordinates = _t.dragCurrentCoordinates, dragInnerOffset = _t.dragInnerOffset, dragLock = _t.dragLock, isDragToMove = _t.isDragToMove, setDragState = _s[1];
        useCancelModeOnEscapeKey(isMouseDown, function () {
            return setDragState(defaultDragState);
        });
        var forceFocusCb = React.useCallback(function () {
            // Force focus if it's not already focused
            if (!nativeActive) {
                forceFocus(wrapperElRef.current);
            }
        }, [nativeActive, wrapperElRef]);
        var getSelectionChildUpdatedRect = React.useCallback(createSelectionChildRectConstrainedGetter({ x: x, y: y, height: height, width: width }, constrainMove, constrainResize, vectorHeight, vectorWidth), [
            x,
            y,
            width,
            height,
        ...
        var gotFocusAfterClickRef = React.useRef(true);
        return (React__default['default'].createElement("g", __assign({ "data-shape-id": shapeId, className: "rse-shape-wrapper", transform: "translate(" + sides.left + "," + sides.top + ")", style: __assign({ cursor: 'move', outline: 'none' }, (disabled ? { pointerEvents: 'none' } : {})), ref: wrapperElRef, focusable: !disabled ? 'true' : undefined, tabIndex: !disabled ? 0 : undefined, onFocus: function (event) {
            ...
            React__default['default'].createElement(WrappedComponent, __assign({ isBeingChanged: isMouseDown, nativeActive: nativeActive, scale: scale }, props, { width: currentWidth, height: currentHeight })),
            !disabled && handles));
    });
    ...
    return React__default['default'].memo(WrappedShape);
}
...
var ImageLayer = function (_a) {
    ...
    return (React__default['default'].createElement("image", __assign({ href: src, width: naturalWidth, height: naturalHeight }, otherProps)));
};
ImageLayer.propTypes = propTypes$2;

var DefaultDrawPreviewComponent = wrapShape(function (_a) {
    var height = _a.height, width = _a.width;
    return (React__default['default'].createElement("rect", { fill: "rgba(0,0,255,0.5)", height: height, width: width }));
});
...
var propTypes$3 = {
    constrainMove: PropTypes__default['default'].func,
    constrainResize: PropTypes__default['default'].func,
    DrawPreviewComponent: PropTypes__default['default'].oneOfType([
        PropTypes__default['default'].func,
        PropTypes__default['default'].shape({}),
    ]),
    onAddShape: PropTypes__default['default'].func.isRequired,
    onDraw: PropTypes__default['default'].func,
    onDrawEnd: PropTypes__default['default'].func,
    onDrawStart: PropTypes__default['default'].func,
};
var noop = function () { };
var DrawLayer = function (_a) {
    ...
    var _k = React.useState(defaultDragState$1), _l = _k[0], isMouseDown = _l.isMouseDown, dragStartCoordinates = _l.dragStartCoordinates, dragCurrentCoordinates = _l.dragCurrentCoordinates, setDragState = _k[1];
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement("rect", { className: "rse-draw-layer", x: -vectorPaddingLeft, y: -vectorPaddingTop, width: vectorWidth + vectorPaddingLeft + vectorPaddingRight, height: vectorHeight + vectorPaddingTop + vectorPaddingBottom, fill: "transparent", onMouseDown: function (event) {
                // Ignore anything but left clicks
                if (event.buttons !== 1)
                    return;
        ...
        draggedRect && (React__default['default'].createElement(DrawPreviewComponent, { height: draggedRect.height, disabled: true, isInternalComponent: true, scale: scale, shapeId: "rse-internal-draw-component", width: draggedRect.width, x: draggedRect.x, y: draggedRect.y }))));
};
DrawLayer.propTypes = propTypes$3;

var DefaultSelectionDrawComponent = wrapShape(function (_a) {
    var height = _a.height, width = _a.width;
    return (React__default['default'].createElement("rect", { fill: "rgba(140,179,255,0.3)", height: height, width: width }));
});

var DefaultSelectionComponent = wrapShape(function (_a) {
    var height = _a.height, scale = _a.scale, width = _a.width;
    return (React__default['default'].createElement("rect", { fill: "transparent", stroke: "rgba(140,179,255,1)", strokeWidth: 2 / scale, height: height, width: width }));
});
...
var useChildAddDeleteHandler$1 = function (eventEmitter, onSelectionChange, selectedShapeIds, selectionElRef, wrappedShapeActionRefsRef) {
    var selectedChildrenDidChangeRef = React.useRef(false);
...
var propTypes$4 = {
    ...
    keyboardTransformMultiplier: PropTypes__default['default'].number,
    minimumDistanceForSelection: PropTypes__default['default'].number,
    onChange: PropTypes__default['default'].func,
    onDelete: PropTypes__default['default'].func,
    onSelectionChange: PropTypes__default['default'].func.isRequired,
    selectedShapeIds: PropTypes__default['default'].arrayOf(PropTypes__default['default'].string.isRequired).isRequired,
    SelectionComponent: PropTypes__default['default'].elementType,
    selectionComponentProps: PropTypes__default['default'].shape({}),
    SelectionDrawComponent: PropTypes__default['default'].elementType,
};
var SelectionLayer = function (_a) {
    ...
    var _k = React.useState(defaultDragState$2), _l = _k[0], isMouseDown = _l.isMouseDown, dragStartCoordinates = _l.dragStartCoordinates, dragCurrentCoordinates = _l.dragCurrentCoordinates, setDragState = _k[1];
    ...
    var selectionElRef = React.useRef(null);
    var wrappedShapeActionRefsRef = React.useRef({});
    ...
    var selectedShapeActionRefs = selectedShapeIds
        ...
        .filter(Boolean);
    var simulatedTransformRef = React.useRef(0);
    var selectionDrawComponent = null;
    if (isMouseDown) {
        if (selectionIsLargeEnough()) {
            var selectionRect = getRectFromCornerCoordinates(dragStartCoordinates, dragCurrentCoordinates);
            selectionDrawComponent = (React__default['default'].createElement(SelectionDrawComponent, { shapeId: "rse-internal-selection-draw-component", disabled: true, height: selectionRect.height, isInternalComponent: true, width: selectionRect.width, x: selectionRect.x, y: selectionRect.y }));
        }
    }
    ...
    if (selectedShapeActionRefs.length >= 2) {
        ...
        selectionComponent = (React__default['default'].createElement(SelectionComponent, __assign({ keyboardTransformMultiplier: keyboardTransformMultiplier }, selectionComponentProps, { shapeId: SELECTION_COMPONENT_SHAPE_ID, isInternalComponent: true, ref: selectionElRef, onIntermediateChange: function (intermediateRect) {
    ...
    return (React__default['default'].createElement("g", { onMouseDown: function (event) {
            // Ignore anything but left clicks
            if (event.buttons !== 1)
                return;
        ...
        React__default['default'].createElement("rect", { className: "rse-selection-layer", x: -vectorPaddingLeft, y: -vectorPaddingTop, width: vectorWidth + vectorPaddingLeft + vectorPaddingRight, height: vectorHeight + vectorPaddingTop + vectorPaddingBottom, fill: "transparent", onMouseDown: function (event) {
                // Ignore anything but left clicks
                if (event.buttons !== 1)
                    return;
