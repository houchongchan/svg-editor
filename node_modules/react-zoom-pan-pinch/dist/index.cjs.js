...
var getTransformStyles = function (x, y, scale) {
    return "translate3d(".concat(x, "px, ").concat(y, "px, 0) scale(").concat(scale, ")");
};
...
var TransformComponent = function (_a) {
    ...
    return (React__default["default"].createElement("div", { ref: wrapperRef, className: "react-transform-wrapper ".concat(styles.wrapper, " ").concat(wrapperClass), style: wrapperStyle },
        React__default["default"].createElement("div", { ref: contentRef, className: "react-transform-component ".concat(styles.content, " ").concat(contentClass), style: contentStyle }, children)));
};
